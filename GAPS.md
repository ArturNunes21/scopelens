...
| G16 | GitHub Actions desabilita workflows agendados após 60 dias sem atividade — quebra o anti-pause do Supabase silenciosamente | Projeto Supabase pode dormir sem aviso | Usar pinger externo (cron-job.org/UptimeRobot) em vez de depender só do GH Actions | Infra | 🔲 Pendente (aguarda conta Supabase) |
